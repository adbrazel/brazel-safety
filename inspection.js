...
class InspectionController {
    ...
    async saveAfterSignatureLock() {
        try {
            ...
            console.log('✅ Inspection draft saved after signature lock');
        } catch (error) {
            console.warn('Inspection signature draft save skipped:', error?.message || error);
        }
    }
